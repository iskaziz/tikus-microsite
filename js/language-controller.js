(function registerTikusLanguageController(global) {
  ...
  const translations = Object.freeze({
    en: Object.freeze({
      ...
      'gallery.filmSummary': 'Film summary',
      'summary.eyebrow': 'Film summary',
      'summary.heading': 'TIKUS at a glance',
      'summary.intro': 'Official poster, synopsis, principal credits and cast.',
      'summary.posterAlt': 'Official TIKUS poster in red, black and warm paper tones, with the title stacked vertically, rat silhouettes and cast credits.',
      'summary.posterCaption': 'Official poster',
      'summary.production': 'Feisk Productions presents',
      'summary.release': 'In cinemas 3 September 2026',
      'summary.synopsis': 'A group of guests attending a “healing” programme at a retreat are stranded when heavy rain cuts off every route out. The situation grows increasingly dire when it is revealed that there is a murderer among them.',
      'summary.director': 'Director',
      'summary.screenplay': 'Screenplay',
      'summary.producers': 'Producers',
      'summary.executiveProducers': 'Executive Producers',
      'summary.productionCompany': 'Production Company',
      'summary.cast': 'Cast',
      'summary.hashtagsLabel': 'TIKUS hashtags',
      'summary.meetCast': 'Meet the cast',
      'summary.whereToWatch': 'Where to watch',
      'cinema.eyebrow': 'Where to watch',
      'cinema.heading': '22 cinemas nationwide',
      'cinema.intro': 'Select a state on the map to see participating cinemas, addresses and directions.',
      ...
      'cinema.mapLabel': 'Stylised map of Malaysia showing states with TIKUS screenings',
      'cinema.mapNote': 'Stylised map — not to scale. Select a numbered state marker or use the state buttons below.',
      'cinema.statesLabel': 'States and territories with TIKUS cinema locations',
      'cinema.locations': 'Cinema locations',
      'cinema.all': 'All locations',
      'cinema.allHeading': '{count} cinemas nationwide',
      'cinema.allIntro': 'Choose a state to see cinema names, addresses and directions.',
      'cinema.statesCount': '13 screening areas',
      'cinema.cinemaCount': '{count} cinema',
      'cinema.cinemasCount': '{count} cinemas',
      'cinema.address': 'Address',
      'cinema.openMaps': 'Open in Maps',
      'cinema.openMapsAria': 'Open {cinema} in Maps',
      'cinema.stateButtonAria': 'View {state}, {count} cinemas',
      'cinema.selectionStatus': '{selection} selected.',
      'cinema.disclaimer': 'Cinema locations are based on the TIKUS release list. Addresses were checked against current cinema or mall listings; schedules can change, so confirm before travelling.',
      'cinema.meetCast': 'Meet the cast',
    ...
    ms: Object.freeze({
      ...
      'gallery.filmSummary': 'Ringkasan filem',
      'summary.eyebrow': 'Ringkasan filem',
      'summary.heading': 'TIKUS secara ringkas',
      'summary.intro': 'Poster rasmi, sinopsis, kredit utama dan barisan pelakon.',
      'summary.posterAlt': 'Poster rasmi TIKUS dalam tona merah, hitam dan kertas hangat, dengan tajuk tersusun menegak, siluet tikus dan kredit pelakon.',
      'summary.posterCaption': 'Poster rasmi',
      'summary.production': 'Feisk Productions mempersembahkan',
      'summary.release': 'Di pawagam 3 September 2026',
      'summary.synopsis': 'Sekumpulan tetamu yang menyertai program “healing” di sebuah tempat peranginan terkandas apabila hujan lebat memutuskan segala laluan keluar. Keadaan menjadi semakin meruncing apabila didedah ada seorang pembunuh di kalangan mereka.',
      'summary.director': 'Pengarah',
      'summary.screenplay': 'Lakon Layar',
      'summary.producers': 'Penerbit',
      'summary.executiveProducers': 'Penerbit Eksekutif',
      'summary.productionCompany': 'Syarikat Penerbit',
      'summary.cast': 'Pelakon',
      'summary.hashtagsLabel': 'Hashtag TIKUS',
      'summary.meetCast': 'Kenali barisan pelakon',
      'summary.whereToWatch': 'Lokasi tayangan',
      'cinema.eyebrow': 'Lokasi tayangan',
      'cinema.heading': '22 pawagam seluruh negara',
      'cinema.intro': 'Pilih negeri pada peta untuk melihat pawagam yang mengambil bahagian, alamat dan arah perjalanan.',
      ...
      'cinema.mapLabel': 'Peta Malaysia bergaya yang menunjukkan negeri dengan tayangan TIKUS',
      'cinema.mapNote': 'Peta bergaya — bukan mengikut skala. Pilih penanda negeri bernombor atau gunakan butang negeri di bawah.',
      'cinema.statesLabel': 'Negeri dan wilayah dengan lokasi pawagam TIKUS',
      'cinema.locations': 'Lokasi pawagam',
      'cinema.all': 'Semua lokasi',
      'cinema.allHeading': '{count} pawagam seluruh negara',
      'cinema.allIntro': 'Pilih negeri untuk melihat nama pawagam, alamat dan arah perjalanan.',
      'cinema.statesCount': '13 kawasan tayangan',
      'cinema.cinemaCount': '{count} pawagam',
      'cinema.cinemasCount': '{count} pawagam',
      'cinema.address': 'Alamat',
      'cinema.openMaps': 'Buka dalam Maps',
      'cinema.openMapsAria': 'Buka {cinema} dalam Maps',
      'cinema.stateButtonAria': 'Lihat {state}, {count} pawagam',
      'cinema.selectionStatus': '{selection} dipilih.',
      'cinema.disclaimer': 'Lokasi pawagam berdasarkan senarai tayangan TIKUS. Alamat disemak dengan senarai pawagam atau pusat beli-belah semasa; jadual boleh berubah, jadi semak sebelum bertolak.',
      'cinema.meetCast': 'Kenali barisan pelakon',
