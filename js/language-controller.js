(function registerTikusLanguageController(global) {
  ...
  const translations = Object.freeze({
    ...
    ms: Object.freeze({
      ...
      'cast.bio.qiu': 'Qiu Qatina ialah seorang pelakon dan penggiat seni Malaysia dengan pengalaman lebih sedekad dalam industri seni persembahan. Graduan Universiti Teknologi MARA (UiTM) dengan Ijazah Sarjana Muda Seni Persembahan dan kini sedang mengikuti pengajian Sarjana Seni Kreatif di ASWARA, beliau telah membina kerjaya yang pelbagai merangkumi teater, drama dan filem. Qiu telah terlibat dalam pelbagai produksi pentas yang mendapat pujian serta projek layar sambil meraih pengiktirafan. Berakar dalam amalan seni dan penyelidikan akademik, karya Qiu digerakkan oleh kepercayaan bahawa seni bukan sekadar satu bentuk ekspresi, tetapi suatu proses penemuan diri.\n\n“Seorang seniman tidak berkarya untuk melarikan diri daripada realiti, tetapi untuk mendedahkan kebenaran yang tidak mampu diungkapkan oleh kesunyian.”',
      'cast.bio.fattah': 'Fattah Fawzy ialah seorang pembikin filem, pelakon, penggiat teater dan penyanyi-penulis lagu Malaysia. Beliau percaya pada persembahan yang jujur dan berpijak di bumi nyata, dengan membawa keikhlasan serta persediaan yang teliti kepada setiap watak. Di samping kerjanya dalam filem dan teater, beliau turut berkongsi pengalaman melalui bengkel, sesi perkongsian dan kolaborasi bersama pelajar serta pembikin filem yang sedang membina kerjaya. Latar belakangnya sebagai penulis dan pengarah turut membentuk pendekatannya terhadap penceritaan, sama ada di pentas mahupun di layar.',
