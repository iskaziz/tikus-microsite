(function registerTikusLanguageController(global) {
  ...
  const translations = Object.freeze({
    en: Object.freeze({
      ...
      'cinema.selectorPlaceholder': 'Choose a state',
      'cinema.selectorHelp': 'Choose a state or territory to see its participating cinemas.',
      'cinema.promptHeading': 'Choose a state',
      'cinema.promptIntro': 'Use the state selector to find participating cinemas near you.',
    ...
    ms: Object.freeze({
      ...
      'cinema.selectorPlaceholder': 'Pilih negeri',
      'cinema.selectorHelp': 'Pilih negeri atau wilayah untuk melihat pawagam yang mengambil bahagian.',
      'cinema.promptHeading': 'Pilih negeri',
      'cinema.promptIntro': 'Gunakan pemilih negeri untuk mencari pawagam yang mengambil bahagian berhampiran anda.',
