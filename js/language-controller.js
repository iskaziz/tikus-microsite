(function registerTikusLanguageController(global) {
  ...
  const translations = Object.freeze({
    en: Object.freeze({
      ...
      'producerFeisal.eyebrow': "Producer's Statement",
      'producerFeisal.heading': "Producer's Statement",
      'producerFeisal.name': 'Feisal Azizuddin',
      'producerFeisal.statement1': 'A murder mystery is not the type of film often produced for a Malaysian audience. Tikus! written and directed by my mother, Ellina Abdul Majid, satirizes aspects of the Malaysian society and poses questions about the direction the world is heading.',
      'producerFeisal.statement2': "The story develops over 4 acts, featuring a fantastic ensemble cast of both experienced and emerging actors. Highlights include witty dialogue and chaotic situations that Malaysians will relate to. Many rhymes and riddles infused in the story indicate my mother's clear, clever vision and the dry humour she injects into the writing. The production was shot in three locations: primarily a bungalow, a greenhouse and a commercial building, each of which adds layers of richness through its delicate set design.",
      'producerFeisal.statement3': "I believe Tikus! is a brave, fresh offering that encourages viewers to think, deduce and solve a mystery as it unravels before them. Down the road, I'm positive that the film will be remembered as one that diversified and enriched Malaysian cinema.",
      ...
      'cinema.heading': '16 confirmed cinemas nationwide',
      ...
      'cinema.statsLabel': 'Tikus! cinema release network: 16 confirmed cinemas, 8 GSC, 5 TGV and 3 independent cinemas',
      ...
      'cinema.disclaimer': 'Confirmed cinema locations reflect the current Tikus! theatrical allocation, including the FINAS Skim Wajib Tayang Borang C dated 27 August 2026 and subsequent confirmed additions. Schedules can change, so confirm before travelling.',
      'cast.eyebrow': 'Cast',
    ...
    ms: Object.freeze({
      ...
      'producerFeisal.eyebrow': 'Kenyataan Penerbit',
      'producerFeisal.heading': 'Kenyataan Penerbit',
      'producerFeisal.name': 'Feisal Azizuddin',
      'producerFeisal.statement1': 'Misteri pembunuhan bukanlah jenis filem yang sering diterbitkan untuk penonton Malaysia. Tikus!, yang ditulis dan diarahkan oleh ibu saya, Ellina Abdul Majid, menyindir beberapa aspek masyarakat Malaysia dan menimbulkan persoalan tentang arah yang sedang dituju dunia.',
      'producerFeisal.statement2': 'Cerita ini berkembang dalam empat babak, menampilkan barisan pelakon ensemble yang hebat, terdiri daripada pelakon berpengalaman dan bakat baharu. Antara kekuatannya ialah dialog yang cerdas dan situasi kacau-bilau yang dekat dengan pengalaman rakyat Malaysia. Pelbagai rima dan teka-teki yang diselitkan dalam cerita memperlihatkan visi ibu saya yang jelas dan bijak, serta humor kering yang disuntikkannya ke dalam penulisan. Produksi ini dirakam di tiga lokasi: terutamanya sebuah banglo, sebuah rumah hijau dan sebuah bangunan komersial, yang masing-masing menambah lapisan kekayaan melalui reka bentuk setnya yang teliti.',
      'producerFeisal.statement3': 'Saya percaya Tikus! ialah sebuah karya yang berani dan segar yang menggalakkan penonton berfikir, membuat deduksi dan menyelesaikan misteri ketika ia terbongkar di hadapan mereka. Pada masa hadapan, saya yakin filem ini akan dikenang sebagai sebuah karya yang mempelbagaikan dan memperkayakan sinema Malaysia.',
      ...
      'cinema.heading': '16 pawagam disahkan seluruh negara',
      ...
      'cinema.statsLabel': 'Rangkaian tayangan Tikus!: 16 pawagam disahkan, 8 GSC, 5 TGV dan 3 pawagam bebas',
      ...
      'cinema.disclaimer': 'Lokasi pawagam yang disahkan mencerminkan peruntukan tayangan semasa Tikus!, termasuk FINAS Skim Wajib Tayang Borang C bertarikh 27 Ogos 2026 dan penambahan yang disahkan selepas itu. Jadual boleh berubah, jadi semak sebelum bertolak.',
